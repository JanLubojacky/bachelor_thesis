...
/******************************************************************************/
#define AI_ECG_MODEL_NAME          "ecg"
#define AI_ECG_ORIGIN_MODEL_NAME   "mb3_100hz_5s_ucfiltcompressed"

/******************************************************************************/
#define AI_ECG_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ECG_INPUTS_IN_ACTIVATIONS   (4)


/******************************************************************************/
#define AI_ECG_IN_NUM        (1)
#define AI_ECG_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 500, 1, 1, 1, NULL), \
}
#define AI_ECG_IN_SIZE { \
  AI_ECG_IN_1_SIZE, \
}
#define AI_ECG_IN_SIZE_BYTES { \
  AI_ECG_IN_1_SIZE_BYTES, \
}
#define AI_ECG_IN_1_HEIGHT      (500)
#define AI_ECG_IN_1_CHANNEL     (1)
#define AI_ECG_IN_1_SIZE        (500 *  1)
#define AI_ECG_IN_1_SIZE_BYTES  (AI_ECG_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_ECG_OUT_NUM       (1)
#define AI_ECG_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_ECG_OUT_SIZE { \
  AI_ECG_OUT_1_SIZE, \
}
#define AI_ECG_OUT_SIZE_BYTES { \
  AI_ECG_OUT_1_SIZE_BYTES, \
}
#define AI_ECG_OUT_1_CHANNEL     (1)
#define AI_ECG_OUT_1_SIZE        (1)
#define AI_ECG_OUT_1_SIZE_BYTES  (AI_ECG_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_ECG_N_NODES (44)
 ...
 * @ref ai_ecg_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_ECG_*
 * defines into file @ref ecg.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
